          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-gray-100">
                ...
                <div className="mb-4 p-2 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-700">
                  <strong>Logo tips:</strong> PNG with transparent background • Max 2MB • Horizontal logos work best
                </div>
