...
const COURSE_STATUSES = {
  submitted: { label: 'Processing', color: 'blue', icon: 'clock' },
  in_progress: { label: 'Generating', color: 'yellow', icon: 'refresh' },
  pending_review: { label: 'Ready for Review', color: 'purple', icon: 'eye' },
  revision_requested: { label: 'Changes Requested', color: 'orange', icon: 'edit' },
  approved: { label: 'Approved', color: 'green', icon: 'check' },
  delivered: { label: 'Completed', color: 'green', icon: 'package' },
...
════════════════════════════════════════════════════════════════════════════════`;
  ...
  const downloadAuditTrail = (job, isClientView = false) => {
    ...
    w.document.write('</div><div class="ftr"><strong>END OF AUDIT TRAIL</strong><br>Auto-generated by AI Course Builder | Navigant Learning</div></body></html>');
    w.document.close();
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {myJobs.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">Get started by creating your first course from an SOP</p>
              <button
                onClick={() => setCurrentView('submit')}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Generate a GxP-compliant SCORM course from your SOP</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• <strong>Format:</strong> PDF or DOCX with selectable text (not scanned images)</li>
                </ul>
              </div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-500 transition-all cursor-pointer"
                  ...
                  {uploadedFile ? (
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">PDF or DOCX • Max 50MB • Up to 30 pages</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              {submissionSuccess && (
                <div className="mt-6 p-6 bg-green-50 border-2 border-green-500 rounded-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-green-900 mb-2">Course Generation Started!</h3>
                      <p className="text-green-800 mb-2">
                        <strong>Course ID:</strong> {submissionSuccess.jobId}
                      </p>
